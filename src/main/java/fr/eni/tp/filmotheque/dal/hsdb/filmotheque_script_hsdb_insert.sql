...
INSERT INTO MEMBRE (email,nom,prenom,password,admin) VALUES ('pmontembault@campus-eni.fr','MONTEMBAULT','Philippe', '{bcrypt}$2a$10$0g3xzuioWFxQLVdmc8LRKOb.sVxyH/uQQjdNg.CPX7tg3cYRK3VTe',1);/*Mot de Passe = philippe*/
...
INSERT INTO MEMBRE (email,nom,prenom,password,admin) VALUES ('sgobin@campus-eni.fr','GOBIN','Stéphane','{bcrypt}$2a$10$B5U29ajHsIKd8aY3c/JNn.xTJpOCAeoXvT9XvfzbbHGP4iIFV9Lkm',1);/*Mot de Passe = stephane*/
...
INSERT INTO AVIS (note,commentaire,id_membre,id_film) VALUES (4,'On rit du début à la fin',1,3);
